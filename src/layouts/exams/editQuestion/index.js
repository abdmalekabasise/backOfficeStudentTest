...
export default function EditQuestion() {
  ...
  const {
    value: question2,
    setValue: question2SetValue,
    inputChangeHandler: question2ChangeHandler,
    inputBlurHandler: question2BlurHandler,
    hasError: question2HasError,
  } = useFormInput((value) => value.trim() !== "");
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      if (data && data.question) {
        ...
        question2SetValue(data.question.question2);
        const split_string = data.question.options[0].split(",");
        ...
        option5SetValue(data.question.options[4]);
                  ...
                  <Grid container spacing={5}>
                    ...
                    <Grid item xs={12} md={12}>
                      <MDInput
                        ...
                        onBlur={question2BlurHandler}
                        fullWidth
                        error={question2HasError}
                        success={!question2HasError}
                      />
                      {question2HasError && (
                        <MDTypography variant="caption" color="error">
                          Please enter a valid question.
