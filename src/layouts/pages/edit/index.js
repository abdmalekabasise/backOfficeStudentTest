  ...
  return (
    <DashboardLayout>
      ...
      <MDBox pt={10} pb={3}>
        ...
        <input className="form-control" id="msg_subject" type="text" name="subject" required data-error="Please enter your message subject" value={name}
        ...
        <textarea className="form-control" rows={3} id="message" name="message" required data-error="Write your message" defaultValue={html}
        ...
        <textarea className="form-control" rows={3} id="messa" name="mess" required data-error="Write your message" defaultValue={css}
